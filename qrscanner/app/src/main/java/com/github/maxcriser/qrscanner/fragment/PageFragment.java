...
public class PageFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static PageFragment newInstance(final int page, final LoaderManager pGetSupportLoaderManager, final Application pGetApplication, final Context pContext) {
        getSupportLoaderManager = pGetSupportLoaderManager;
        getApplication = pGetApplication;
        context = pContext;
        final Bundle args = new Bundle();
